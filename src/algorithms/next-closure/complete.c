...
ListNode* ee_co_next_closure(AF *attacks) {
	...
	*/
	...
	closure_semi_complete_opt(current, victims_list, attacked_by, current);
	...
	} while (next_conflict_free_semi_complete_intent_opt(attacks, victims_list, attacked_by, current, current));
